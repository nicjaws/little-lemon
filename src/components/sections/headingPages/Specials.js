    ...
    <section className="specials">
      ...
      <section className="specials-cards">
        ...
        <SpecialCard
          ...
          price="$16.99"
          description="Toasted bread, topped with tomato, zuchinni, and cheese. Seasoned with
                 salt and olive oil. Really tasty and nice food to share"
        />
        <SpecialCard
          image={LemonDessert}
          name="Lemon Dessert"
          ...
          description="Fresh baked lemon bread coated in salt and sugar. Powdered in citrus
                 and lemon zest. Really tasty and nice dessert to share"
        />
      </section>
